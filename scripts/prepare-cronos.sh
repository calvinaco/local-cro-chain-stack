...
if [[ $ACCOUNT_EXISTS -gt 0 ]]; then
    echo "✅ Cronos genesis file already initialized. Skipped."
else
    ...
    echo "✅ Cronos genesis file initialized."
fi
...
i=0; while [[ $i -lt $VALIDATOR_COUNT ]]; do
    ...
    echo "✅ Cronos validator$i home folder created"
    ...
    echo "✅ Cronos validator$i create validator transaction generated"
...
i=0; while [[ $i -lt $VALIDATOR_COUNT ]]; do
    ...
    echo "✅ Cronos validator$i prepareation completed"
    ((i=i+1))
done
